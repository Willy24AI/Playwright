...
async def warm_profile(profile: dict, token: str, run_google: bool = True, run_youtube: bool = True,
    ...
    async with async_playwright() as p:
        ...
        context = browser.contexts[0] if browser.contexts else await browser.new_context(
            viewport=browser_cfg.get("viewport"), locale=browser_cfg.get("locale"),
        ...
        await page.set_viewport_size({
            "width": vp["width"] + random.randint(-4, 4),
        ...
        if no_google:
            ...
            if fast_mode:
                ...
                if random.random() < 0.40: sessions.append("shopping")
        ...
        for session_type in sessions:
            ...
            try:
                ...
                if is_proxy_error(error_msg):
                    ...
                    if recovered:
                        plog(pid, f"✅ Proxy recovered ({proxy_recovery_attempts}/{MAX_PROXY_RECOVERIES}). Continuing.")
                    else:
...
def run_scheduler(selected_ids=None, run_google=True, run_youtube=True, run_wander=True,
    ...
    while True:
        ...
        asyncio.run(run_all(selected_ids, run_google, run_youtube, run_wander, current_day,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--strike-keyword", type=str, nargs="+", default=None)
    parser.add_argument("--strike-channel", type=str, default=None)
    parser.add_argument("--strike-window", type=float, default=2.0)
